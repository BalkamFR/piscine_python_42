...
class TournamentPlatform:
    ...
    def register_card(self, card: TournamentCard) -> str:
        card_name_small: str = card.name.lower()
        name_with_underscores: str = card_name_small.replace(" ", "_")

        number_of_cards: int = len(self.registered_cards) + 1
        card_id: str = f"{name_with_underscores}_{number_of_cards:03d}"
